...
//Đăng nhập cvht
 Route::get('/covan/dangnhap', 'UserController@getLogin');
 Route::post('/', 'UserController@check');
// Route::post('logout', function() {
//     return view('auth/login');
// });
//Phần bí thư
Route::group(['prefix' => 'bithu','middleware'=>'auth:bithu'], function() {
    Route::get('/', function() {
...
//Phần cố vấn học tập
Route::group(['prefix' => 'covan','middleware'=>'auth'], function() {
