		...
		@csrf
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-sm-5">
							<input type="time" class="form-control" id="thoigianbatdau" pattern="[0-9]" min="0" max="10" required name="thoigianbatdau" oninput="setCustomValidity('')" value="{{$hoatdong->thoigian_bd}}">
						</div>
						<div class="col-sm-2">đến</div>
						<div class="col-sm-5">
							<input type="time" class="form-control" id="thoigianketthuc" pattern="[0-9]" min="0" max="10" required name="thoigianketthuc" oninput="setCustomValidity('')" value="{{$hoatdong->thoigian_kt}}">
						</div>
					</div>
